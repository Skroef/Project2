<template>
  <div class="navbar-bookmarks flex items-center">
    ...
    <!-- <div class="bookmark-container align-star-bookmarks">
  ...
  computed: {
    ...
    starredPages () {
      ...
      listOfIcons.push({
        ...
        is_bookmarked: true,
        title: "Drag & Drop",
        url: "/apps/dragAndDrop/dragAndDrop"
      });
      ...
      listOfIcons.push({
        ...
        is_bookmarked: true,
        title: "Activities",
        url: "/apps/activities/activities"
      });
